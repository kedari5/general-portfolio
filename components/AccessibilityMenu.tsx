...
export default function AccessibilityMenu() {
    ...
    useEffect(() => {
        ...
        if (isHighContrast) {
            document.documentElement.classList.add("filter-invert");
        } else {
            document.documentElement.classList.remove("filter-invert");
        }
    ...
    return (
        <div className="relative">
            ...
            <button
                ...
                className="flex items-center justify-center w-12 h-12 rounded-full border border-white/5 bg-surface shadow-sm text-foreground hover:bg-muted hover:text-primary transition-all focus:outline-none focus:ring-2 focus:ring-primary group"
                ...
                <div className="fixed top-20 right-6 z-50 w-[320px] bg-background/95 backdrop-blur-md border border-border shadow-2xl rounded-2xl overflow-hidden flex flex-col max-h-[calc(100vh-100px)] animate-in fade-in zoom-in-95 duration-200">
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-6">
                        ...
                        <button
                            ...
                            className="w-full py-3 px-8 flex items-center justify-center gap-2 bg-[#ef4444]/10 backdrop-blur-md text-[#dc2626] dark:text-[#f87171] rounded-full border-2 border-[#ef4444] dark:border-[#f87171] shadow-[inset_0_0_20px_rgba(239,68,68,0.2)] transition-all focus:outline-none hover:shadow-[inset_0_0_30px_rgba(239,68,68,0.4)] hover:bg-[#ef4444]/20 active:scale-[0.98] font-medium text-sm"
                        >
